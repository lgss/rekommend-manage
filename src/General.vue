  ...
  <div >
    <v-navigation-drawer app absolute :clipped="true" color="blue--lighten-1" v-model="drawer">
      ...
      <v-list>
        ...
        <v-list-item color="primary" @click="changeView('notices')">Notices</v-list-item>
      </v-list>
    </v-navigation-drawer>
    <v-icon large @click.stop="drawer = !drawer"> mdi-chevron-right </v-icon>
    <v-content>
      <component :is="interactionType"/>
    </v-content>
  </div>
</template>
...
import NoticesEditor from './components/NoticesEditor.vue'
/* eslint-disable */
export default {
  components: {
    'theme': ThemeEditor,
